...
?>
    ...
    <?php echo form_open_multipart('upload');?>
      ...
      <input type="text" name="link" size="43" maxlength="255" placeholder="<?= lang('addmeme_link_placeholder') ?>" data-toggle="tooltip" title="<?= lang('addmeme_link_tooltip') ?>" data-placement="auto right" /><br />
