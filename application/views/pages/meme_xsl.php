            ...
            <div class="container-fluid">
                <xsl:element name="div">
                    ...
                    <div class="col-xs-12 col-custom-frontpage col-centered">
                        ...
                        <div class="memedata">
                            <p><?= lang('meme_spicelevel') ?>: <span class="points badge"><xsl:value-of select="points"/></span></p>
                            <p><?= lang('meme_addedby') ?>: <xsl:element name="a"><xsl:attribute name="href">
                                        <xsl:value-of select="profile"/>
                                    </xsl:attribute><xsl:value-of select="uploader"/></xsl:element></p>
                            <p><?= lang('meme_comments') ?>: <a href="comments_page.html"><span class="badge"><xsl:value-of select="comments"/></span></a></p>
                        </div>
